#!/usr/bin/env python3
"""
Simple packaging script for Project Planning skill
...
def package_skill(skill_dir: str, output_path: str = None):
    """
    Package the Project Planning skill into a distributable format.
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("Example: python package_skill.py project-planning")
        sys.exit(1)
